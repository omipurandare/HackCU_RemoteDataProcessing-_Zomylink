...
*
* Description- Config file with information for keys and certificates required for our IoT Thing
*************************************************************************************************/
...
// Get from console
// =================================================
#define AWS_IOT_MQTT_HOST              "a34zxov5n45h2j.iot.us-west-2.amazonaws.com" ///< Customer specific MQTT HOST. The same will be used for Thing Shadow
#define AWS_IOT_MQTT_PORT              8883 ///< default port for MQTT/S
#define AWS_IOT_MQTT_CLIENT_ID         "thisShouldWork" ///< MQTT client ID should be unique for every device
#define AWS_IOT_MY_THING_NAME 	       "thisShouldWork" ///< Thing Name of the Shadow this device is associated with
#define AWS_IOT_ROOT_CA_FILENAME       "root-CA.pem" ///< Root CA file name
#define AWS_IOT_CERTIFICATE_FILENAME   "33370facd9-certificate.pem.crt" ///< device signed certificate file name
#define AWS_IOT_PRIVATE_KEY_FILENAME   "33370facd9-private.pem.key" ///< Device private key filename
// =================================================
